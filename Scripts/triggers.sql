...
BEGIN
	...
	VALUES ('Actividad publicada', 'Tienes una actividad por ver', SYSDATE(), NEW.id_publicacion);
...
BEGIN
	...
	VALUES ('Examen publicado', 'Tienes una publicacion por ver', SYSDATE(), NEW.id_publicacion);
